...
class MainActivity : Activity() {
    ...
    private fun renderHome(){
        ...
        hero.addView(textView("Pick a game. We pick the engine.",23f,0xFFFFFFFF.toInt(),true),LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,ViewGroup.LayoutParams.WRAP_CONTENT).apply{topMargin=dp(10)})
        status=textView("Auto grouping • auto engine routing • fully offline",11f,0xFF8E98A8.toInt())
